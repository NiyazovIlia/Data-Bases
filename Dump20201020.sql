...
--
-- Host: localhost    Database: shop_9
-- ------------------------------------------------------
...
/*!50001 VIEW `new_view` AS select `products`.`name` AS `name_prod`,`catalogs`.`name` AS `name` from (`products` left join `catalogs` on((`products`.`catalog_id` = `catalogs`.`id`))) */;
...
-- Dump completed on 2020-10-20 10:09:23
